...
exports.deepEqual = function deepEqual (a, b) {
  ...
  if (isCounounObject(a)) a = a.toObject();
  if (isCounounObject(b)) b = b.toObject();
...
exports.isCounounObject = function (v) {
  Document || (Document = require('./document'));
  CounounArray || (CounounArray = require('./types').Array);
  CounounBuffer || (CounounBuffer = require('./types').Buffer);

  return v instanceof Document ||
         (v && v.isMongooseArray) ||
         (v && v.isMongooseBuffer);
};
var isCounounObject = exports.isCounounObject;
